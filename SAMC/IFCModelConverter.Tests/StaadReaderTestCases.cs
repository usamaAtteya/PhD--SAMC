...
{
    [TestFixture]
    public class StaadReaderTestCases
    {

        static string _filesBasePath = AppDomain.CurrentDomain.BaseDirectory.Replace("bin\\Debug", "Files");
        static string _generalFilePath = _filesBasePath + @"first issue+GlobalZLoads .std";
        static Model _generalModel = new StaadReader().GetModel(_generalFilePath);
        ...
        public static IEnumerable<TestCaseData> FrameSections_LastRectProfSectName_TestCases
        {
            get
            {
                yield return new TestCaseData(_generalModel, "RectSection-29- 1x0.2");
            }
        }
        ...
        public static IEnumerable<TestCaseData> FrameSections_LastIShapeProfSectName_TestCases
        {
            get
            {
                yield return new TestCaseData(_generalModel, "ISection-27");
            }
        }
